...
public class KMeans {
  ...
  public static void main(String[] args) throws Exception {
    ...
    Path lossFilePath = new Path(output + "/task_2_2.loss");
    ...
    Path top10FilePath = new Path(output + "/task_2_2.txt");
    ...
    Path newClustersFilePath = new Path(output + "/task_2_2.clusters");
    Path newClassesFilePath = new Path(output + "/task_2_2.classes");
